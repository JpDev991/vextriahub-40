...
export const OfficeControlPanel: React.FC = () => {
  ...
  // Funções mockadas para ações (será implementado com Asaas)
  const handleVerDetalhes = (adminId: string) => {
    toast({
      title: "Ver Detalhes",
      description: "Funcionalidade será implementada com integração Asaas",
    });
  };
  ...
  const handleEnviarCobranca = (adminId: string) => {
    toast({
      ...
      description: "Funcionalidade será implementada com API Asaas",
    });
  };
