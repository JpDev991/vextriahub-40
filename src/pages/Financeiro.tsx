...
const Financeiro = () => {
  ...
  const mockContasReceber = [
    { id: 1, cliente: "João Silva", valor: 2500, vencimento: "2024-01-15", status: "pendente" },
    { id: 2, cliente: "Maria Santos", valor: 1800, vencimento: "2024-01-20", status: "vencido" },
    { id: 3, cliente: "Empresa ABC", valor: 5000, vencimento: "2024-01-25", status: "pendente" },
  ];

  const mockContasPagar = [
    { id: 1, fornecedor: "Escritório Virtual", valor: 800, vencimento: "2024-01-10", status: "pago" },
    { id: 2, fornecedor: "Material de Escritório", valor: 350, vencimento: "2024-01-18", status: "pendente" },
    { id: 3, fornecedor: "Software Jurídico", valor: 1200, vencimento: "2024-01-22", status: "pendente" },
  ];
